 ...
 */
MyVector::MyVector() : data(nullptr), n_items(0), n_allocated(0)
{
    /* Setup the variables witht their correct values.
     * I do this using a member initializer list above (http://en.cppreference.com/w/cpp/language/initializer_list)
...
{
    --n_items;
    // Replace the last one with a blank thing
...
void MyVector::reallocate(size_t new_size)
{
    ...
    Thing* new_memory = new Thing[new_size];
