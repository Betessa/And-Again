...
{
    //reallocate to twice the size if size limit reached
    if (n_allocated==0){
        reallocate(1);
    }
...
void MyVector::pop_back()
{
    ...
    Thing* temp = new Thing[n_allocated]; //CORRECT
    //Copy everything to temporary vector except last element
