 ...
 * @param t The thing to addstd::vector<Things>. You need to implement a number of functions in your class that are similar
to the original vector class. You may not use a std::vector in your code.
Your class should have a data pointer that points to a dynamically allocated array. You should keep
 *
