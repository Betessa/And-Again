...
void MyVector::push_back(const Thing &t){
    if (n_items == 0 && n_allocated == 0){
	// New vector, just place this... thing here.
	*data = t;
	n_items = 1;
	n_allocated = 1;
	return;
    ...
    // Vector is not new, vector is full, reallocate.
